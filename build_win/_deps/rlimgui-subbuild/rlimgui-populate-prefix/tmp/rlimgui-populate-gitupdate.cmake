...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "Raylib_5_5"
  WORKING_DIRECTORY "/home/damplex/projects/RFSim/build_win/_deps/rlimgui-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("Raylib_5_5" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: Raylib_5_5")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/Raylib_5_5")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"Raylib_5_5\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/damplex/projects/RFSim/build_win/_deps/rlimgui-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/damplex/projects/RFSim/build_win/_deps/rlimgui-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
